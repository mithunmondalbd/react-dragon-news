...
const Login = () => {
    ...
    const handleLogin = e => {
        ...
        signIn(email, password)
            .then(result => {
                ...
                navigate(navigate?.state ? location.state : '/')
            })
            .catch(error => {
                console.log(error)
            })
    ...
    return (
        <>
            <Navbar></Navbar>
            <div className="relative flex w-96 mx-auto mt-20 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
